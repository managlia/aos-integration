...
public class ActionClassificationTypeController {
	...
	@PostMapping
	public ResponseEntity<Resource<ActionClassificationType>> addActionClassificationType(@RequestBody ActionClassificationType actionClassificationType, HttpServletRequest request ) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Resource<ActionClassificationType>> updateActionClassificationType(@RequestBody ActionClassificationType actionClassificationType, @PathVariable String id) {
